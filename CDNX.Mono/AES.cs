        ...
        public static byte[] DecryptKeyArea(BinaryReader br, uint kaekInd, uint mkInd)
        {
            ...
            try
            {
                ...
                switch (kaekInd)
                {
                    default:
                    case 0:
                        kaekSrc = Utils.StringToByteArray(INIFile.Read("keys", "akaeksrc"));
                        break;
                    case 1:
                        kaekSrc = Utils.StringToByteArray(INIFile.Read("keys", "okaeksrc"));
                        break;
                    case 2:
                        kaekSrc = Utils.StringToByteArray(INIFile.Read("keys", "skaeksrc"));
                        break;
                }
